...
// Changed "0x1c" : "0x1b" to "0x1e" : "0x1d" AND 0x1c : 0x1b to 0x1e : 0x1d
// Changed Use of 27 and 28 to 29 and 30
...
const BN_29$1 = BigInt(29);
const BN_30$1 = BigInt(30);
...
class Signature {
    ...
    static getNormalizedV(v) {
        ...
        if (bv === BN_0$7 || bv === BN_29$1) {
            return 29;
        }
        if (bv === BN_1$3 || bv === BN_30$1) {
            return 30;
        }
...
const BN_29 = BigInt(29);
const BN_30 = BigInt(30);
...
function _parseLegacy(data) {
    ...
    if (r === BN_0$4 && s === BN_0$4) {
        ...
        assertArgument(chainId !== BN_0$4 || (v === BN_29 || v === BN_30), "non-canonical legacy v", "v", fields[6]);
