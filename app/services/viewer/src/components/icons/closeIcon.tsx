...
const CloseIcon: FC<closeIconProps> = (props: closeIconProps) => {
  const { classes, onClick } = props
  return (
    <svg onClick={onClick} style={{width: '24px', height: '24px', margin: '0 1em'}} className={classes} viewBox="0 0 24 24">
